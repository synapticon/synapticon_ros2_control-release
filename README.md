...
## synapticon_ros2_control (humble) - 0.1.3-1

The packages in the `synapticon_ros2_control` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble -e synapticon_ros2_control` on `Thu, 22 Jan 2026 12:06:33 -0000`
...
## synapticon_ros2_control (rolling) - 0.1.2-1
